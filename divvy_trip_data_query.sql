...
SELECT
	*,
	DATEDIFF(MINUTE,started_at,ended_at) AS trip_length, -- Returns the duration of the trip
...
WHERE
	start_station_name IS NOT NULL -- This excludes trips that do not have data on starting location
	AND end_station_name IS NOT NULL -- This excludes trips that do not have data on ending location
